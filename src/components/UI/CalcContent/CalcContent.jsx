...
const CalcContent = ({setModalActive, formik, handleOnChangePromotionBtn}) => {
            ...
            <div className="content-block">
                ...
                <div className="checkbox-block">
                    <input 
                        ...
                        type="checkbox" 
                        defaultChecked={formik.initialValues.promotionCheckValue} 
                        onClick={handleOnChangePromotionBtn}
                    />
