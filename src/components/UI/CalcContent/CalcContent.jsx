    ...
    <div className="calc-block__content calc-block__content_view">
      <div className="content-block">
        ...
        <div className="checkbox-block">
          <input
            className="checkbox-block_check"
            type="checkbox"
            defaultChecked={promotionCheck}
            onClick={handleOnChange}
          />
          <p className="checkbox-block__text">
            <a href="index.html" className="checkbox-block__link">
              Акция
            </a>
            ставка 16,5%
          </p>
        ...
        <div className="copy-text-block">
          <p className="copy-text">
            ...
            <a href="index.html" className="checkbox-block__link">
              c учетом возможных скидок
            </a>
            и соблюдением всех условий по кредиту. Точные условия по кредиту и
            расчет вы получите после подачи заявки. Не является публичной
            офертой.
          </p>
        </div>
        {/* <Button setModalActive={setModalActive} /> */}
        <button className="button-to-send" type="submit">
          Отправить заявку
        </button>
      </div>
